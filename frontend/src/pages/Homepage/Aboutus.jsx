  ...
  return (
    <>
      ...
      <div className="flex flex-row bg-[#ff1f1f] mt-20 h-150 w-screen ml-[calc(50%-50vw)] mr-[calc(50%-50vw)] text-white">
        <div
          className="bg-[#444444] w-[40%] h-auto m-8"
          style={{
      ...
      <div className="p-8 mt-8 flex flex-col gap-5">
        <div className="flex flex-row gap-10">
          <div className="bg-[#ff1f1f] w-48 h-70 rounded-lg" style={{backgroundImage: `url(${blackSuperman})`, backgroundSize: "cover", backgroundPosition:"center"}}></div>
          <div className="w-200">
        ...
        <div className="flex justify-end flex-row gap-10 m-0">
          ...
          <div className="bg-[#ff1f1f] w-48 h-70 rounded-lg" style={{backgroundImage: `url(${strongThumb})`, backgroundSize: "cover", backgroundPosition:"90% 20%"}}></div>
        </div>
      </div>
      <div className="mb-50">
        ...
        <div className="flex flex-row p-10 mt-8 justify-between">
          <div>
            <div className="bg-[#ff1f1f] w-48 h-70 rounded-lg mb-5 justify-self-center" style={{backgroundImage: `url(${AchmadCaesar})`, backgroundSize: "400px", backgroundPosition:"55% 0%"}}></div>
