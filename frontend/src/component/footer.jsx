...
export default function Footer() {
    return (
        <div className="bg-[#444444] w-screen ml-[calc(50%-50vw)] mr-[calc(50%-50vw)] text-white px-5 py-10 mt-20">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link to="/" className="hover:text-[#ff6161]">
              Home
            </Link>
            <Link to="/class" className="hover:text-[#ff6161]">
              Class
            </Link>
            <Link to="/membership" className="hover:text-[#ff6161]">
              Membership
            </Link>
            <Link to="/aboutus" className="hover:text-[#ff6161]">
              About Us
            </Link>
          </div>
